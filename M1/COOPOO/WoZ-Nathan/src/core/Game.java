...
public class Game 
{
    ...
    public void createCharacters()
    {
        ...
        statue = new Enemy("Statue", "I was in the corridor", poolroom, 5, 15, 20,"..\\pictures\\Characters\\Statue.png"); // damage =2 accuraccy = 30, HP=8
        rat_bear = new Enemy("Rat / Bear", "I was in the ritual room", poolroom, 10, 20, 100,"..\\pictures\\Characters\\Rat_bear.png");
            ...
            if (step2Finish) {
                ...
                if (step3Finish) {
                    if (currentRoom == library) {
                        ...
                        // recupere arme
                        DisplayFight statueFight = new DisplayFight(player, statue);    
                        ...
                        if (step5Finish) {
                            ...
                            if (step6Finish) {
                                if (currentRoom == bedroom) {
                                    ...
                                    while (!breakLoop) {
                                        // fenetre pop up pour rentrer le code             
                                        JTextField code = new JTextField("");
                                        JPanel panel = new JPanel(new GridLayout(0,1));
                                        panel.add(new JLabel("The code : "));
                                        panel.add(code);

                                        // Valider ou annuler la réponse
                                        int result = JOptionPane.showConfirmDialog(null, panel, "Test",
                                                JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);

                                        // montrer la réponse + attribution
                                        if (result == JOptionPane.OK_OPTION) {
                                            System.out.println(code.getText());
                                        } else {
                                            System.out.println("Cancelled");
                                        }
                                        essai_code = Integer.parseInt(code.getText());
                                        ...
                                        if (essai_code == safe_code){
                                            ...
                                            System.out.println("You do not find the good number code, the safe door is still closed. \n ");    
                                        }
                                    }
                                        ...
                                        if (step9Finish) {
                                            if (currentRoom == well) {
                                                if (exam) {
                                                    ...
                                                    DisplayFight ghostFight = new DisplayFight(player, ghost);    
                                            ...
                                            if (step10Finish) {
                                                ...
                                                if (step11Finish) {
                                                    if (currentRoom == ritualroom) {
                                                        DisplayFight ratFight = new DisplayFight(player, rat_bear);    
                                                        if (exam) {
                                                    ...
                                                    if (step12Finish) {
                                                        ...
                                                        if (step13Finish) {
                                                            if (currentRoom == livingroom) {
                                                                ...
                                                                //Si bonne rÃ©ponse reprend 10 HP et se bat contre le valet                                                       DisplayFight ratFight = new DisplayFight(player, rat_bear);    
                                                                 DisplayFight valetFight = new DisplayFight(player, valet);    
