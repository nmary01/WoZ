...
public class EnemyTest
{
    ...
    {
        room = new Room ("La seule pièce du jeu", null);
        goodEn = new Enemy("Good", "Premier boss", room,1,1,100, null);
    }
    ...
    {
        Enemy enemy = new Enemy("Captain", "blabla", room,1,1,1, null);
    ...
    {
       Enemy enemy = new Enemy("Captain", "blabla", room,1,1,20, null);
    ...
    {
        Enemy enemy = new Enemy("Captain", "blabla", room,2,2,40, null);
    ...
    public void testName()
    {
        ...
        Enemy badEn1= new Enemy("Jo", "Premier boss", room,1,1,10, null);
    ...
    {
        assertEquals(true, goodEn.testValidity());
        Enemy badEn2= new Enemy("Good", "boss", room,2,2,30, null);
    ...
    public void testRoom()
    {
        ...
        Enemy badEn3 = new Enemy("Good","Premier boss", badRoom,3,3,10, null);
    ...
    {
        assertEquals(true, goodEn.testValidity());
        Enemy badEn4 = new Enemy("Bad Ennemy", "Premier boss", room,4,4,20, null);
        badEn4.setHP(-3);
